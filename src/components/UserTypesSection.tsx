      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Interfaces específicas e otimizadas para cada tipo de usuário,
            garantindo eficiência máxima em suas atividades.
          </p>
        </div>
            ...
            >
              <CardContent className="p-8">
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div
                    className={`w-16 h-16 ${user.color} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform`}
                  >
